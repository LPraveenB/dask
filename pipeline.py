...
def pipeline(
    ...
    train_xgb_task = custom_train_job(
        ...
        container_uri='us-west1-docker.pkg.dev/inventory-solution-382204/dask-docker/xgb-dask:v12',
    ...
    eval_xgb_task = custom_eval_job(
        project_id=PROJECT_ID,
        project_location=REGION,
        container_uri='us-west1-docker.pkg.dev/inventory-solution-382204/dask-dockerdask-mlpipeline-image:latest',
        staging_bucket='user-bucket-dollar-tree',
        job_name=run_name,
        job_suffix='Training' + '_' + run_name_suffix,
...
if __name__ == '__main__':
    ...
    client = RegistryClient(
        host=f"https://us-west1-kfp.pkg.dev/inventory-solution-382204/ml-run-kfp-repo"
    )
    ...
    job = vertex_ai.PipelineJob(
        ...
        template_path=f"https://us-west1-kfp.pkg.dev/inventory-solution-382204/ml-run-kfp-repo/model-training/" + versionName,
    )
